create proc SP_Mostrar_Compra_Total
as
begin
 SELECT ID_Factura AS [CODIGO FACTURA]  ,(Select CONVERT(varchar,Fecha,103))  AS FECHA,  (select convert(char(8), Fecha, 108) as [hh:mm:ss])  AS HORA,(E.[Primer Nombre] +' '+ E.[Primer Apellido]) 
 ...
 INNER JOIN Empleado E ON FC.ID_Empleado = E.Cedula order by Fecha desc
 end